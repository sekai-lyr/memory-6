...
public class Sekai2048MonetizationLeadDO {
    ...
    public MonetizationLead convertToModel() {
        MonetizationLead lead = new MonetizationLead();
        BeanUtils.copyProperties(this, lead);
        return lead;
    }
